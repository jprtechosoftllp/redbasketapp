...
import axiosInstace from 'apps/manager-ui/src/utils/axiosInstace';
import { toast } from 'sonner';
import useManager from 'apps/manager-ui/src/hooks/useManager';
import { useRouter } from 'next/navigation';
import { useDispatch } from 'react-redux';
import { addvendor } from 'apps/manager-ui/src/utils/redux/slice/vendorSlice';
...
export default function page() {
  ...
  const sendOTPMutation = useMutation({
    mutationFn: async (values: { email: string, username: string, phone: string, formType: string }) => {
      try {
        const res = await axiosInstace.post('/api/vendor/send-otp', values);
  ...
  const submitMutation = useMutation({
    mutationFn: async (values: {
      ...
      try {
        const res = await axiosInstace.post('/api/vendor/create-vendor', values);
